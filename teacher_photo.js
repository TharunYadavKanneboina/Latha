        ...
        <View style={styles.emptyHeader} />
            <Text style={{ fontSize: 29 ,fontWeight:'bold',textAlign:'center'}}>Upload Event Media</Text>
                ...
                />
                            ...
                            <TouchableOpacity style={styles.filePickerButton} onPress={handleChooseMedia}>
    <Text style={{ color: 'white' }}>Choose Files</Text>
</TouchableOpacity>

<TouchableOpacity style={{ backgroundColor: '#003153', padding: 10, alignItems: 'center' ,width:360,borderRadius:12}} onPress={handleMediaUpload}>
